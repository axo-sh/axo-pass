...
import {SshPasswordRequest} from '@/mod/ssh-askpass/SshAskpassScreen/SshPasswordRequest';
...
export const SshAskpassScreen = ({initialRequest}: SshAskpassScreenProps) => {
  ...
  if ('success' in request) {
    // show loader because while we have successfully posted an input ssh askpass may prompt again
    return (
      <Layout centered>
        <Loader />
      </Layout>
